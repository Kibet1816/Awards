# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2019-08-05 07:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categories', models.ManyToManyField(blank=True, to='app.categories')),
            ],
        ),
        migrations.CreateModel(
            name='Rating',
        ...
        migrations.AddField(
            model_name='project',
            name='technologies',
            field=models.ManyToManyField(blank=True, to='app.technologies'),
        ),
        migrations.AddField(
            model_name='project',
            name='user',
